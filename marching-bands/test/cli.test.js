...
/**
 * Smoke test for the Marching Bands CLI.
 *
...
const FIXTURE = path.resolve(__dirname, 'fixtures/mb-12.yaml');

test('builds a puzzle HTML successfully', () => {
  const out = path.join(fs.mkdtempSync(path.join(os.tmpdir(), 'mb-smoke-')), 'out.html');
